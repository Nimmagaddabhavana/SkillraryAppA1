...
public class WebDriverUnity<javaUtility> {
	WebDriver driver;
	/**
...
public void takeScreenshot(WebDriver driver,String ClassName,javaUtility jutil) {
    ...
    File dest = new File("./Screenshot"+ ClassName + "_"+   jutil.getCurrentTitle()+".png");
    try {
...
public void takeScreenshort(WebDriver sdriver, String methodName, String sjutil) {
